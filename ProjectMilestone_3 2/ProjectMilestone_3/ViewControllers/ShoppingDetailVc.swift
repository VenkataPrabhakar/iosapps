...
class ShoppingDetailVc: UIViewController,  UITableViewDelegate, UITableViewDataSource {
    ...
    {
        return arrayShoppingForm.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        let objForm = arrayShoppingForm[indexPath.row]
