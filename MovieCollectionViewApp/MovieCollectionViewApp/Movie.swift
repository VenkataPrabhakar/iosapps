...
let movies : [Movie] = [
    ...
    Movie(title:"RRR",image:UIImage(named: "rrr")!,releasedYear: "2022",movieRating: "10.0",boxOffice: "450.3M"),
    Movie(title:"KGF-2",image:UIImage(named: "KGF2")!,releasedYear: "2022",movieRating: "8.5",boxOffice: "200.3M"),
]
